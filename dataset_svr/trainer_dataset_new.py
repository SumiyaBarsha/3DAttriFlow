...
def build_dataset(args):
    # Create Datasets
    dataset_train = dataset_new.ShapeNet(args, train=True)
    dataset_test = dataset_new.ShapeNet(args, train=False)
...
def build_dataset_val(args):
    ...
    # Create Datasets
    dataset_test = dataset_new.ShapeNet_val(args, train=False)
